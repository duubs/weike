        ...
        <div class="tpl-left-nav tpl-left-nav-hover">
            ...
            <div class="tpl-left-nav-list">
                <ul class="tpl-left-nav-menu">
                    ...
                    <li class="tpl-left-nav-item">
                        <a href="{:url('Admin/chart')}" class="nav-link tpl-left-nav-link-list">
                        ...
                        <div >
                            <div >
					            ...
					            <select  style="width:80px;height:30px;">
					              ...
					              <option value="singleTopicSelection">单选题</option>
					              <option value="multipleChoice">多选题</option>
                                  <option value="fillUpTheTopic">填空题</option>
                                  <option value="answerQuestion">解答题</option>
					            </select>
					            题类筛选：
                                <select style="width:80px;height:30px;">
                                    <option value="all">全部</option>
                                    <option value="commonTopic">普通题</option>
                                    <option value="selectTheTopic">精选题</option>
                                    <option value="theUniversityEntranceExamQuestions">高考题</option>
                                    <option value="theExaminationQuestions">中考题</option>
                            </div>
                                ...
                                <table class="am-table am-table-striped am-table-hover table-main">
                                    ...
                                    <tbody>
                                        <tr>
                                            ...
                                            <td>1</td>
                                            <td><a href="#">Thetitle management  </a></td>
                                            <td>default</td>
