        ...
        <div class="tpl-left-nav tpl-left-nav-hover">
            ...
            <div class="tpl-left-nav-list">
                <ul class="tpl-left-nav-menu">
                     ...
                     <li class="tpl-left-nav-item">
                        <a href="{:url('User/user')}" class="nav-link active">
                            ...
                            <span>用户信息 </span>
                                        ...
                                        <!--题库信息-->
                    <li class="tpl-left-nav-item">
                        <a href="{:url('Admin/questionBank')}" class="nav-link active">
                            <i class="am-icon-home"></i>
                            <span>题库信息</span>
                        </a>
                    </li>
                                       <!--课程信息-->
                    <li class="tpl-left-nav-item">
                        <a href="{:url('Course/user')}" class="nav-link active">
                            <i class="am-icon-home"></i>
                            <span>课程信息</span>
                        </a>
                    </li>
                    ...
                    <li class="tpl-left-nav-item">
                        <a href="{:url('Admin/chart')}" class="nav-link tpl-left-nav-link-list active">
               ...
               12
                    ...
                    <li class="tpl-left-nav-item">
                        ...
                        <ul class="tpl-left-nav-sub-menu">
                            <li>
                                <a href="{:url('Admin/tableFontList')}">
                                    <i class="am-icon-angle-right"></i>
                                    <span>文字表格</span>
                                    <i class="am-icon-star tpl-left-nav-content-ico am-fr am-margin-right"></i>
                                </a>

                                <a href="{:url('Admin/tableImagesList')}">
                                    <i class="am-icon-angle-right"></i>
                                    <span>图片表格</span>
