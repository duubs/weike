				...
				<hr class="place_line"/>
					...
					<div class="form">
						...
						<div class="form_group">
							...
							<div class="form_ctrl">
								<input class="btn_large_blue01" type="submit" id="submit" value="发起退款"/>
							</div>
							<div class="form_ctrl" style="margin-left: 20px;">
								<input class="btn_large_blue01" type="submit" id="cancel" value="取消"/>
							</div>
						</div>
...
<script type="text/javascript">
	$(function(){
		$('#submit').click(function(){
			var order_id = $('#leng').val()
			if (confirm("确认发起退款？")) {
				 $.get("/index/LearningCenter/refundDo",{order_id:order_id},function(data){
                    if (data == 1) {
                    	alert('发起退款成功')
