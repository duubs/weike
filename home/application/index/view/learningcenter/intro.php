...
<script type="text/javascript" src="http://static.vko.cn/v8/common/config.js"></script>
		...
		<link rel="stylesheet" type="text/css" href="http://static.vko.cn/v8/v8s/vip/css/intro.css" />

	</head>

	<body>
		<script src="http://static.vko.cn/v8/common/js/header.js"></script>
		<div class="intro">
			<p class="tit">什么是V币？</p>
			<p>用过微课圈的小朋友们都知道，V币是有巨大作用的，可以用来解锁课程（解锁的课程一年内随意观看）、付款时候抵扣现金（10个币可抵扣一元人民币）、打赏别人（目前只在微课圈）、参与排行榜（目前只在微课圈）等功能。可以说有V币，微课学习不费力。</p>
			<p>网站里的V币数=旧版网站中充值的V币数乘以10+微课圈的V币数量</p>
			<p>（因为微课圈中V币的充值是1元=10V币，原网站里是1元=1V币）。</p>
			<p class="tit">V币是怎么来的？</p>
			<p>你可以在个人中心-我的V币页面中的充值按钮进行充值，充值的比例是1元=10V币。另外下载微课圈，在微课圈中会有很多赠送和完成小任务获得的V币的途径。</p>
			<p class="tit">V币的管理</p>
			<p>V币总数和记录可在“个人中心-账户-我的V币”中查询，在微课圈和网站中记录都是同步的；V币购买记录可在“个人中心-我的订单”中查询。请放心使用。</p>
			<div class="pic clearfix">
				<p class="tit">下载微课圈，这里有很多种方法让你赚取V币。</p>
				<div class="pic1">
					<p>扫描二维码下载微课圈</p>
					<img src="http://static.vko.cn/quan/images/q1m.png"/>
				</div>
				<div class="pic2">
					<p>更多咨询联系</p>
					<img src="http://static.vko.cn/v8/v8s/vip/images/zhaoshang1.png"/>
				</div>
			</div>
		</div>
		<script src="http://static.vko.cn/v8/v8s/common/js/footer.js"></script>
	</body>
