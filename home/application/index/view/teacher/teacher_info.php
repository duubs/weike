...
(function() {
  ...
  s.parentNode.insertBefore(hm, s);
    ...
    <meta charset="UTF-8" />
    <title>微课网—全学科学习引领者-名师个人中心展示</title>
    <link rel="stylesheet" type="text/css" href="http://static.vko.cn/xiaoyuan/common/css/common.min.css" />
    <link rel="stylesheet" type="text/css" href="http://static.vko.cn/v8/v8s/teacher/common/css/teacourTop.min.css"/>
    <link rel="stylesheet" type="text/css" href="http://static.vko.cn/xiaoyuan/teaCourse/common/css/record.min.css"/>
    <link rel="stylesheet" type="text/css" href="http://static.vko.cn/v8/v8s/teacher/common/css/teaCenterfb.min.css"/>
    <link rel="stylesheet" type="text/css" href="http://static.vko.cn/xiaoyuan/teaCourse/common/css/teaCenter.min.css"/>
    <style>
        .footer{
            width: 100%!important;
...
<body>
    ...
    <div class="teaInfo">
        <div class="face">
            <div class="facepic">
                <div class="userPic vko-user-large">
                    <a href="#"><img src="http://cdn.vkoimg.cn/upload/pic/user/face/13705838391843098_big.jpg" alt="" />
        ...
        <div class="teainfo">
            <p class="tit"><b>张连涛</b><span><!--<i>1</i>年教龄--></span></p>
            <p><span>化学高级教师</span><p></p><!--<a href="#">修改信息</a>--></p>
        </div>
    </div>
    <div class="teaIncro">
        <div class="introTit">
        ...
        <div class="introCont">
            <textarea name="" rows="" cols="">重点中学骨干教师</textarea>
            <p>重点中学骨干教师</p>
...
<div class="courCont">
    <div class="contMains">
        <div class="contTop">
            <ul>
                <li class="cur"><a href="#">张连涛老师的微课程</a></li>
            </ul>
        </div>
        <div class="fbCont" id="fbCont">
...
<!-- 加载公共部分 -->
<script type="text/javascript" src="http://static.vko.cn/v8/goods/js/teacher_detail.js"></script>
<script type="text/javascript">
    $(document).ready(function(){
        /*标签*/
        $('.allTag').click(function(){
            $(this).parent('.biaoQian').next('.allTagBox').slideToggle();
        });
        $('.allTagBox').mouseleave(function(){
            $(this).slideUp();
        });
    });
